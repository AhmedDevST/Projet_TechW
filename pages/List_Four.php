...
<?php //message
     if(isset($_GET['mess'])){
      ...
      ?>
      <meta http-equiv="refresh" content="0; url=http://localhost/Projet_TechW/pages/List_Four.php "/>; 
   <?php } ?>
<?php
   $list=Four::affich();
?>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Liste de Fourinsseurs</h4>
                      ...
                      <?php  foreach($list as $row){  ?>
                        ...
                        <td><a href="../imgs/<?=$row->photo ?>"><img src="../imgs/<?=$row->photo ?>" width="50PX"  alt="Photo"></a> </td>
                          ...
                          <td>  
                            ...
                            <a href="../Controles/Controle.php?idper=<?= $row->id ?> ">  <button type="button" class="btn btn-danger btn-fw" onclick="return confirm('Etes vous sur de supprimer ce fournisseur?')" >Supprimer</button></a>
                          </td>
                        </tr>
                      <?php } ?>
                      </tbody>
