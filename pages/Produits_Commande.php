        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Liste de Produites Commandes</h4>
                  ...
                  <div class="table-responsive">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                     <?php foreach($list_LnCommande as $row) {?>
                      <tr>
                  ...
                  <a href="Gestion_Commande.php"><button type="button" class="btn btn-outline-light btn-fw" style="margin-top:20px;">
